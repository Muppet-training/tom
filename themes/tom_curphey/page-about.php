  ...
  <main onclick="menuCheck();" onLoad="checkURL();" id="main_body" class="about">
    <section class="about_header">
      <div class="inner_header">
        <div class="video">
          <div onclick="video_overlay();" class="inner_video" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/video.png);">
        ...
        <div class="intro">
          ...
          <ul>
            <li class="left" onclick="smoothScroll(document.getElementById('separator'))">
    ...
    <section id="my-story">
      <section class="overview">
        ...
        <div>
          <img src="<?php echo get_template_directory_uri(); ?>/images/video.png);" alt="Tom">
        </div>
      </section>
    ...
    <section class="quote values">
      ...
      <ul>
        ...
        <li>I'm a cheap Heart Sergent</li>
        <li>Idea Killer</li>
      </ul>
    </section>
  </main>
